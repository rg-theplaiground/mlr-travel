...
export const AddPaymentMethodModal: React.FC<AddPaymentMethodModalProps> = ({
  ...
  const [paymentType, setPaymentType] = React.useState<'personal' | 'company'>('company');
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, nameOnCard: e.target.value })}
              required
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <select
                      ...
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, expMonth: e.target.value })}
                    >
                  ...
                  <div className="relative flex-1">
                    <select
                      ...
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, expYear: e.target.value })}
                    >
              ...
              <Input
                ...
                maxLength={4}
                value={formData.cvv}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, cvv: e.target.value })}
                required
              />
            </div>
          </div>
