...
import {
  ...
  User, Mail, Smartphone, Users, MapPin,
...
export const MatchBookingWizard: React.FC<MatchBookingWizardProps> = ({ match, userData: _userData, onClose }) => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <div className="space-y-2">
                      ...
                      <DateRangePicker
                        ...
                        endDate={null}
                        onChange={(start: Date | null) => updateForm('checkIn', strFromDate(start))}
                        tripType="one-way"
                    ...
                    <div className="space-y-2">
                      ...
                      <DateRangePicker
                        ...
                        endDate={null}
                        onChange={(start: Date | null) => updateForm('checkOut', strFromDate(start))}
                        tripType="one-way"
                        placeholder="mm/dd/yyyy"
